...
void insert_maxHeap(vector<int>& v, int x){
   ...
   while(cur_idx != 0){
      ...
      if(v[par_idx]< v[cur_idx]) /* max be root*/
...
// delete ROOT, 
// for this 
void delete_heap(vector <int>& v, vector <int>& v2){
...
int main(){
   ...
   cout<<"maxHeap : "; print_heap(v);
   for(int i=0; i<n; i++)delete_heap(v, v2);
   cout<<"sorted : "; print_heap(v2);
